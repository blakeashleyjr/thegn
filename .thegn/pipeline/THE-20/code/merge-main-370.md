...
while this one was in review. Reported conflicts / failure:
    ...
    conflicts with main (2nd time — THE-17 landed mid-merge): crates/thegn-svc/src/control/mod.rs, crates/thegn-svc/src/control/routes.rs, crates/thegn-svc/tests/control_schema.rs, docs/api/control-v1.json
