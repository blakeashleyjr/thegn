# THE-13 — merge main and re-gate (Lead work order)
...
while this one was in review. Reported conflicts / failure:
    ...
    conflicts with main: crates/thegn-host/src/daemon/service.rs, crates/thegn-host/src/run.rs, crates/thegn-host/src/sidebar_view.rs, crates/thegn-svc/src/control/grpc.rs, crates/thegn-svc/src/control/http.rs
