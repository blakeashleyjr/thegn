# THE-17 — merge main and re-gate (Lead work order)
...
while this one was in review. Reported conflicts / failure:
    ...
    conflicts with main: crates/thegn-core/src/control.rs, crates/thegn-core/src/mcp/state.rs, crates/thegn-host/src/main.rs, crates/thegn-svc/src/control/client.rs, crates/thegn-svc/src/control/grpc.rs, crates/thegn-svc/src/control/http.rs
