...
THE-628 tracks the reported task manager process table flicker. Every model
...
bounded admission and row ordering deterministic, and preserve sampled process
identity during passive refresh and pending signal confirmation. This repairs
existing behavior without adding controls, sampling faster, or new features.
...
Linear THE-628; coordinated review and delivery registration under THE-614.
