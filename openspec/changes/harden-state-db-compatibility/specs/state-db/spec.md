...
Every shared-DB operation SHALL declare a minimum readable/writable schema
requirement before opening the shared store, distinct from migration authority.
A client MAY use a compatible older schema without permission to migrate it.
