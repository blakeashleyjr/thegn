...
## 2. Ceilings + resolution (superzej-core)
...
## 3. Bundle sub-vault (superzej-core)
...
## 4. Budget rollup (superzej-proxy)
...
- [x] 5.1 CLI `superzej zone list|create|rm [--force]|assign <zone> [repo]`.
