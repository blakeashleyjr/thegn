...
This change records and affirms thegn's opsec posture. It MUST NOT weaken the
...
- **Sandbox-by-default for agents (AJ 443).** Each worktree's interactive process
  ...
  `crates/thegn-core/src/sandbox.rs`. An agent worktree is containerized unless
...
- **Viewer / VCS client scope.** thegn is terminal-native and delegates editing
