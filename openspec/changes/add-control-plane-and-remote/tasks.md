...
- [ ] 1.1 — Add `daemons`, `session_leases`, `pairings` tables + CRUD
...
- [ ] 2.1 — Move `portable-pty` pane ownership into a long-lived daemon that
...
- [ ] 2.2 — Warm-reattach: a reattaching client receives the current emulator
...
- [ ] 3.1 — Daemon control API over AK 445/451/452: attach/detach, list
...
- [ ] 3.2 — `szhost` verbs that talk to a running instance (open worktree,
...
- [ ] 4.1 — `szhost serve` advertises a pairing URL; clients pair (token in
...
- [ ] 5.1 — On last-client detach, open a grace-period lease keeping the remote
...
- [ ] 6.1 — Read-mostly companion surface over AK 451 + AI 422/423 push: monitor
