...
- [x] 6.3 Archive reconciliation: channel/clamp/doctor tests, clippy for both
      feature sets, and the manual stable/dev matrix in 6.1–6.2 are the
      retained evidence. Feature commit `563d0697` is in current history; the
      former pre-PR aggregate gate is not a remaining product requirement.
