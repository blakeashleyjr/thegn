...
thegn SHALL translate a natural-language git intent into a concrete git
...
- **THEN** thegn produces a mapped git operation with an explanation and any
...
thegn SHALL show the proposed command, its explanation, and warnings and
