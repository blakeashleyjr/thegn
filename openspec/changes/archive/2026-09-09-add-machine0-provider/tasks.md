...
- [x] 10.3 Archive reconciliation: clippy/unit coverage and the end-to-end live
      lifecycle smoke in 10.1–10.2 are the retained evidence. Feature commit
      `6c6ef061` and its hardening follow-ups are in current history; the old
      pre-PR `just ci` reminder is not a remaining requirement.
