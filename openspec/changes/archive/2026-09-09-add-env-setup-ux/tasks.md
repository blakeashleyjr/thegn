...
- [x] 5.3 Archive reconciliation: workspace tests, clippy, and ratchet evidence
      are recorded in 5.2; implementation commits `4fbdb6e8`, `7bc84d10`, and
      `4882da04` are in current history. The former aggregate `just ci`
      reminder is not a remaining capability or an unclaimed test result.
