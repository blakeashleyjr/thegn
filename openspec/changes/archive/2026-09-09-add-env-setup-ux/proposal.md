...
Implementation commits `4fbdb6e8`, `7bc84d10`, and `4882da04` are in current
history. Secret-resolution/config-write unit tests, CLI authoring tests,
wizard/panel tests, workspace tests, clippy, and config/example ratchets
evidence the accepted layered secret, environment authoring, CLI, and TUI
scope. The proposal, design, and deltas remain aligned with that delivered
boundary.
