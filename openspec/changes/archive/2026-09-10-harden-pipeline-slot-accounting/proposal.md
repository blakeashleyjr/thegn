...
Linear: THE-121 (delivery residual for the 2026-08-29 incident)
...
- **`thegn dispatch claim`** — the atomic alternative to `list` + `put`. Runs
  ...
  non-empty justification as a note in the same transaction without bypassing
  capacity. Unknown stage names fail closed instead of becoming unbounded.
