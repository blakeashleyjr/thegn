...
- [x] 7.4 Archive reconciliation: the scoped suites, `just quick`, treefmt, and
      strict OpenSpec validation in 7.1–7.3 are the retained evidence; feature
      commit `95b8d748` and merge `d78fc3f3` are in current history. The old
      full-`just ci` land-gate reminder is not a remaining requirement.
