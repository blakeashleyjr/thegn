...
- [x] 4.4 Archive reconciliation: workspace tests/clippy and the live cleanup
      verification in 4.2–4.3 are the retained evidence. Provider feature
      commit `50e0f31b` is in current history; the old aggregate `just ci`
      reminder is not an additional delivered capability.
