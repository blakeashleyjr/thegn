...
- [x] 5.2 Archive reconciliation: the cross-store bundle/fetch and same-store
      tests in 5.1 are the retained acceptance evidence, and feature commit
      `8776f3c4` is in current history. The former pre-PR `just ci` reminder is
      not a remaining product requirement.
