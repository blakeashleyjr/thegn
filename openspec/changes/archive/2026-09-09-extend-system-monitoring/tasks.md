...
- [x] 6.1 Scoped quick/nextest verification recorded by commit `4d3d8023`
      covers the delivered metrics, monitor, collector, config, and doctor
      paths. The stale full-e2e baseline refresh was a repository-wide gate,
      not an unimplemented THE-44 requirement.
- [x] 6.2 Strict OpenSpec validation passed during archive-readiness review.
