...
- [x] 4.1 Run the targeted core/host/svc tests and quick checks required by the
      ...
      ratchet checks.
- [x] 4.2 Reconciled merge `76d85c9c` against the parser, routing, trust-strip,
      provider, bounded-worker, pack snapshot, attention-edge, and doctor test
      coverage. The former ignored-result note was a landing-process ratchet,
      not unfinished sound-pack behavior.
- [x] 4.3 Strict OpenSpec validation passed during archive-readiness review.
