...
- [x] 7.3 Archive reconciliation: registry, capability-negotiation, supervisor,
      consumer, and doctor tests plus scoped clippy/nextest are the retained
      evidence. Feature commit `5e4e7c22` and merge `a8d20c4e` are in current
      history; the old reviewer-only full-CI reminder is not claimed.
