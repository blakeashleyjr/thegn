...
## 4. Docs + delivery evidence

- [x] 4.1 Claim `fork-session` with real prose in
      `docs/help/daemon-and-sessions.md` (help + prose ratchets).
- [x] 4.2 Reconciled the delivered surface against merge `0fe0e345`, the
      generated control schema, and the focused core/daemon/CLI tests. Full
      workspace CI is a repository landing gate, not an outstanding THE-29
      product requirement.
