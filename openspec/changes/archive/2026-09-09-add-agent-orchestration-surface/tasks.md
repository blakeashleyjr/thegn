...
- [x] 6.4 Archive reconciliation: scoped core/host tests, smoke coverage, and
      catalog ratchets are recorded above; feature commit `935b46dd` and merge
      `1a5954cd` are in current history. The historical full-`just ci` land-gate
      instruction is not claimed as an additional product deliverable.
