...
- [x] 6.2 Reconciled commit `0b49a318` against the shipped config model,
      pane-spawn precedence, resolved mounts, workspace/global switcher scope,
      transient feedback, and focused core/host tests. Full workspace CI is a
      landing gate, not an outstanding identity requirement.
- [x] 6.3 Strict OpenSpec validation passed during archive-readiness review.
