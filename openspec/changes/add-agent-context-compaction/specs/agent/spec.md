...
superzej SHALL provide a deterministic, pure templater that collapses repetitive
...
superzej SHALL apply compaction only when a scrollback window exceeds a configured
