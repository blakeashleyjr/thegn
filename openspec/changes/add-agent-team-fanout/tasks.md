...
## 1. Core fan-out plan (thegn-core)
...
## 2. Fan-out execution (thegn-host)

- [ ] 2.1 `thegn team <task> [--agents|--best-of-N|--agent] [--base] [--sandbox]
...
## 4. Review & merge wiring (thegn-host)
...
- [ ] 5.1 Document `thegn team` (both modes) in the CLI/agent doc section.
