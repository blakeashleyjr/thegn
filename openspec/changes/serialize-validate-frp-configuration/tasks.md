...
- [x] Replace handwritten FRP TOML interpolation with typed serde documents.
- [x] Apply strict typed final parse and protected equality comparison.
- [x] Reject raw `extra` and TCP/UDP zero remote ports before serialization.
