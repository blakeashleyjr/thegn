...
source=json.loads(Path('/tmp/thegn-maintenance08-primary-redirect-compile-approval-20260915.json').read_text())['source']
build=json.loads(Path('/tmp/thegn-maintenance08-native-redirect-artifact-admission-20260915.json').read_text())
assert build['source']==source and build['exit_code']==0 and len(build['artifacts'])==1
plan=json.loads(Path('/tmp/thegn-maintenance08-native-redirect-selection-plan-20260915.json').read_text())
selection=[]
for label in ['svc']:
...
manifest=Path('/tmp/thegn-maintenance08-native-redirect-selected-20260915.json')
...
log=Path('/tmp/thegn-maintenance08-focused-native-redirect-20260915.log');receipt=Path('/tmp/thegn-maintenance08-focused-native-redirect-receipt-20260915.json')
