...
- **Help ratchet (`crates/thegn-host/src/help/ratchet_tests.rs`, runs in
  ...
  `test/help-prose-ratchet.txt` (claimed but unwritten),
  `test/help-context-ratchet.txt` (unclaimed panel contexts), and
  `test/help-panel-prose-ratchet.txt` (unwritten panel sections). The keybindings
