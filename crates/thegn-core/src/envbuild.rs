...
pub(crate) fn build_env_placement(
    ...
    match envc.placement {
        ...
        PlacementMode::Provider => {
            ...
            // `exec_command`, or the thegn `vps-ssh` self-bridge for VPS
...
mod tests {
    ...
    #[test]
    fn vps_provider_defaults_to_the_thegn_self_bridge() {
    ...
    fn effective_provider_id_is_per_worktree() {
        ...
        assert_eq!(def, effective_provider_id("", wt, Some("thegn")));
        ...
        assert_eq!(effective_provider_id("shared", wt, Some("thegn")), "shared");
        ...
        let deep = Path::new(
            "/home/u/very/deeply/nested/path/that/keeps/going/thegn/worktrees/thegn/an-extremely-long-branch-name-that-overflows",
        );
