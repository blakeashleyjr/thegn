...
fn h2_profile_overlay_sets_network_block() {
    ...
    use thegn_core::config::{Config, ProfileConfig, SandboxOverlay};
...
fn h3_profile_switch_teardown() {
    ...
    thegn_core::sandbox::teardown_by_path(worktree);
    ...
    thegn_core::sandbox::ensure(&spec_personal).expect("ensure personal failed");
