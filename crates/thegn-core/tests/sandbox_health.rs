...
use thegn_core::sandbox::{Backend, Mount, SandboxLimits, SandboxSpec, ensure, health_check};
...
fn f4_non_oci_backend_always_healthy() {
    ...
    let mut spec = base_spec("thegn-e2e-f4-noop");
