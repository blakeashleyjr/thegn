...
//! `test/smoke.sh` / `superzej env up`); the pure plan it consumes is unit-tested
//! in core.

use anyhow::{Result, bail};
use superzej_core::config::DataMode;
use superzej_core::placement::{Placement, SshPlacement};
use superzej_core::projection::ProjectionSpec;
...
mod tests {
    use super::*;
    use superzej_core::placement::{SshPlacement, TransportKind};
    ...
    fn rsync_builders_carry_ssh_knobs_and_trailing_slashes() {
        use superzej_core::placement::SshPlacement;
