...
use superzej_core::transport_error::{
...
pub trait HostRunner: Send {
    ...
    fn probe_headroom(&mut self) -> Result<superzej_core::host_probe::Headroom, ClassifiedErr> {
...
impl HostRunner for OciRunner {
    ...
    fn probe_headroom(&mut self) -> Result<superzej_core::host_probe::Headroom, ClassifiedErr> {
        ...
        superzej_core::host_probe::parse_headroom(&out.stdout)
