...
use superzej_core::transport_error::{ClassifiedErr, classify_exec, describe_exec_failure};
...
pub(super) fn ssh_stream(
    ...
    let out = superzej_core::retry::with_retry(
        "offset query",
        &superzej_core::retry::StepBudget::new(
            superzej_core::retry::ReconnectPolicy::probe(),
...
/// ssh's own 255.
fn rsync_class(code: Option<i32>, stderr: &str) -> superzej_core::transport_error::ErrorClass {
    match code {
        Some(10) | Some(12) | Some(30) => superzej_core::transport_error::ErrorClass::Transient,
