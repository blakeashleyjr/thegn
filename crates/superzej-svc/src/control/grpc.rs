...
use superzej_core::control::{Scope, Verb, required_scope};
use superzej_core::control_wire::{EventFrame, LeaseEventKind, PairingState};
...
/// Generated bindings for `superzej.control.v1` (see `proto/…/control.proto`).
#[allow(clippy::all, clippy::pedantic)]
pub mod proto {
    tonic::include_proto!("superzej.control.v1");
}
...
impl Control for GrpcControl {
    ...
    async fn events(
        ...
        let hello = frame_to_proto(&EventFrame::Hello(superzej_core::control_wire::Hello {
            proto: superzej_core::control_wire::PROTO_VERSION,
...
mod tests {
    use super::*;
    use superzej_core::control_wire::Hello;
