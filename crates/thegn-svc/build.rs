...
//! `proto/thegn/control/v1/control.proto` via `protox` — a pure-Rust proto
...
fn main() {
    ...
    {
        println!("cargo:rerun-if-changed=proto/thegn/control/v1/control.proto");
    }
    let fds = protox::compile(["proto/thegn/control/v1/control.proto"], ["proto"])
