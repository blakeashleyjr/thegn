...
//!
//! The pure format/scope decisions live in `thegn_core::control` (tested
...
impl AuthCtx {
    ...
    pub fn require(&self, need: thegn_core::control::Scope) -> Result<(), super::ControlError> {
