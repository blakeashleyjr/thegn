//! [`AppTile`] — the contract the thegn host (and the standalone harness)
//! drive every frame.
//!
...
//! differ. The discipline that keeps thegn at ~0% idle is encoded here —
...
/// and redraw." Embedded: thegn pulses its `TerminalWaker`. Standalone: the
...
/// A full TUI application embeddable as a thegn app tab.
///
