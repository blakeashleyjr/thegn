...
use superzej_core::media::{LoopMode, MediaState, PlaybackState, QueueItem};
...
mod tests {
    ...
    fn sample() -> MediaState {
        MediaState {
            ...
            can_seek: true,
            kind: superzej_core::media::MediaKind::Video,
            ..Default::default()
        }
    }
    ...
    fn video_only_keys_gate() {
        ...
        audio.kind = superzej_core::media::MediaKind::Audio;
