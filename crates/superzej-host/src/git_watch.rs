...
/// `--git-common-dir`, then runs [`superzej_core::util::heal_main_checkout_worktree`]
...
pub(crate) fn spawn_main_checkout_heal(
    ...
    tokio::task::spawn_blocking(move || {
        ...
        let Some(common_parent) = superzej_core::util::git_cmd(&from)
        ...
        if superzej_core::util::heal_main_checkout_worktree(&common_parent)
