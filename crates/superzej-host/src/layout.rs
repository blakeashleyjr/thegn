...
mod tests {
    ...
    fn rail_width_is_not_floored_to_the_full_panel_minimum() {
        ...
        // SIDEBAR_MIN_WIDTH.
        let l = compute_full(160, 40, true, false, false, PanelWidth::Normal, RAIL_COLS, false, 0.0, 0, false);
    ...
    fn rail_survives_below_the_sidebar_width_threshold() {
        ...
        let full = compute_full(narrow, 20, true, false, false, PanelWidth::Normal, SIDEBAR_COLS, false, 0.0, 0, false);
        assert!(full.sidebar.is_none(), "full panel hides when narrow");
        let rail = compute_full(narrow, 20, true, false, false, PanelWidth::Normal, RAIL_COLS, false, 0.0, 0, false);
        assert_eq!(
