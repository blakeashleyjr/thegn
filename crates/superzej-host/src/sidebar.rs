...
pub enum SortMode {
    ...
    /// `superzej_core::attention`). Ordering follows the hysteresis-stable
...
pub struct ViewState {
    ...
    pub terminals_section: superzej_core::config::TerminalsSection,
}
...
/// [`superzej_core::attention::MqStatus::glyph`] vocabulary (also used by
...
fn mq_chip(
    ...
    if mq == superzej_core::attention::MqStatus::Landed {
        return None;
    }
...
pub fn build_rows(
    ...
    let hide_terminals = db_terminals.is_empty()
        && view.terminals_section == superzej_core::config::TerminalsSection::NonEmpty;
    if !hide_terminals {
...
mod tests {
    ...
    fn terminals_section_nonempty_hides_banner_until_a_terminal_exists() {
        ...
        let view = ViewState {
            terminals_section: superzej_core::config::TerminalsSection::NonEmpty,
            ..Default::default()
        };
