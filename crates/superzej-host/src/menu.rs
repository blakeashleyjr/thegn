...
pub enum MenuChoice {
    ...
    // groups (forget them in superzej) without touching branch or files.
...
/// "remove from superzej — keep all files" (matching VS Code's "remove folder
    ...
    MenuOverlay::new_with_default(
        ...
        vec![
            item(
                ...
                Some('f'),
                "remove from superzej — keep all files",
