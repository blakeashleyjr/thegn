...
//!
//! The routing logic itself is the pure `superzej_core::notification_route`
...
pub struct NotifyState {
    ...
    debounce: Mutex<superzej_core::notify_debounce::NotifyDebounce>,
...
impl NotifyState {
    ...
    pub fn new(
        ...
        std::sync::Arc::new(NotifyState {
            cfg: Mutex::new(cfg),
            debounce: Mutex::new(superzej_core::notify_debounce::NotifyDebounce::default()),
    ...
    pub fn decide(
        ...
        let Some(kind) = parse_kind(kind) else {
            return RouteDecision {
                record: true,
                effective_priority: superzej_core::notification::Priority::Notice,
                desktop: true,
                toast: false,
                sound: None,
            };
    ...
    pub fn dnd_active(&self) -> bool {
        ...
        let cfg = self.cfg.lock().unwrap();
        superzej_core::notification_route::scheduled_dnd_active(
            &cfg.dnd,
