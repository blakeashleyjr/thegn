...
/// false (the default) szhost's own log errors are never surfaced as user
...
pub(crate) fn issue_urgency(p: superzej_core::issue::IssuePriority) -> u8 {
...
mod tests {
    ...
    fn never_emits_when_self_log_errors_off() {
        // The default: szhost's own log errors are diagnostics, never surfaced.
