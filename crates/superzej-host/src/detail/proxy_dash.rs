...
//! rendering of the same `superzej_core::proxy::stats` rollup the daemon's
//! `/stats` endpoint and `superzej proxy stats` serve. A child module of
...
use crate::chrome::S;
use crate::seg::Tok;
use superzej_core::db::ProxyBudgetRow;
...
mod tests {
    ...
    use superzej_core::proxy::stats::rollup;
