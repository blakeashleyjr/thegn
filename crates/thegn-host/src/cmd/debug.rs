//! `thegn debug <action>` — the BugStalker debugger integration.
//!
...
//! inside a thegn pane, a session inherits that pane's sandbox and remote
...
use thegn_core::debug::{self, attach_argv, bs_tool, launch_argv};
...
pub enum Action {
    ...
    /// thegn pane to debug within that pane's sandbox/placement.
    Run {
