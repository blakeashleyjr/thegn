//! `thegn zone <action>` — manage zones: named groups of workspaces inside a
...
//! in config (`[zone.<name>]`). See [`thegn_core::zone`].

use anyhow::{Result, bail};
use std::path::PathBuf;
use thegn_core::config::Config;
use thegn_core::db::Db;
use thegn_core::store::{WorkspaceStore, ZoneDeleteOutcome, ZoneStore};
