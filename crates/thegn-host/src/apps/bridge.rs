...
impl CellStyle {
    fn of(cell: &tg_kit::ratatui::buffer::Cell) -> CellStyle {
        let m = cell.modifier;
...
mod tests {
    use super::*;
    use tg_kit::ratatui::layout::Rect as RRect;
    use tg_kit::ratatui::style::{Color as RColor, Style};
    use tg_kit::ratatui::text::Line;
    use tg_kit::ratatui::widgets::{Paragraph, Widget};
