...
//! [`tg_kit::InputEvent`] an [`AppTile`] consumes — the embedded mirror of the
//! standalone harness's crossterm translator (`tg_kit::input::from_crossterm`).
//!
//! [`AppTile`]: tg_kit::AppTile

use termwiz::input::{KeyCode, Modifiers as TwMods};
use tg_kit::input::{InputEvent, Key, Modifiers};
