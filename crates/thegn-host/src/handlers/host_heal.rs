...
use thegn_core::heal::HealSchedule;
...
impl Default for HealState {
    fn default() -> Self {
        HealState {
            ...
            schedule: thegn_core::heal::active_schedule(),
...
/// every other driver.
fn spawn_heal(name: &str, cfg: &thegn_core::config::Config, host_ui: &crate::host_flow::HostUiTx) {
...
mod tests {
    ...
    use thegn_core::host::{HostFailure, HostStep};
