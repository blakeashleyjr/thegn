...
/// Who created a host and therefore what superzej may do to it. `Managed`
/// hosts are created and destroyed by superzej (autoscale, cloud reach);
/// `Independent` hosts are user-owned machines superzej was pointed at —
