...
pub struct AppsConfig {
    /// Tab focused on startup. Valid ids: "work", "agent".
...
",
    ...
    fn effective_tab_order_dedups_and_appends_missing() {
        let a = AppsConfig {
            default_tab: "work".into(),
            tab_order: vec!["bogus".into(), " work ".into()],
        };
    ...
    fn config_overlay_apply_sets_every_field() {
        let overlay = ConfigOverlay {
            ...
            apps_default_tab: Some("work".into()),
            apps_tab_order: Some(vec!["work".into()]),
        ...
        assert_eq!(cfg.metrics.max_body_bytes, 4096);
        assert_eq!(cfg.apps.default_tab, "work");
        assert_eq!(cfg.apps.tab_order, vec!["work"]);
